...
-- 테이블 데이터 webdb.membership:~13 rows (대략적) 내보내기
...
INSERT INTO `membership` (`idx`, `mid`, `pwd`, `name`, `nickname`, `gender`, `tel`, `hobby`, `email`, `joinday`, `userinfor`, `level`, `userdel`, `content`) VALUES
	...
	(17, 'hkd1234', '$2a$10$u4ve2YmA9evA.sykUlMnGeimmcuyxPq0yT9UAxPO1kZN/WOAM29JO', '홍길동', '홍장군', '남자', '010-3423-2704', '등산/', 'hkd1234@hanmail.net', '2020-06-23 07:54:49', 'OK', 3, 'NO', '홍길동입니다.\r\n오래전에 가입했다가 강퇴 당했습니다.\r\n억울해서 다시 가입합니다.\r\n또? 강퇴??? 시킬때?... 폭파~~~~');
...
-- 테이블 데이터 webdb.photogallery:~44 rows (대략적) 내보내기
