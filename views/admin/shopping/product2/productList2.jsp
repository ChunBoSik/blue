  ...
  <script>
    ...
    function deleteProduct(){
      ...
      if(cnt==0){
        ...
        document.deleteForm.action="${contextPath}/admin/deleteProduct";
    ...
    function stateList(){
      ...
      location.href="${contextPath}/admin/productlist?state="+state;
    }  
  </script>
</head>
<body>
...
<div style="width:90%;margin:0 auto;">
  ...
  <div style="display:inline;float:right;margin-right:10px;">
    <form name="searchform" class="form-inline" method="post">
      <div style="float:left;margin-bottom:5px;margin-right:5px;">   
        <input type="text" class="form-control"  name="searchString" style="width:300px;"placeholder="대·중·소분류 또는 상품명을 입력하세요"/>
      </div>
      <div style="float:left;margin-bottom:5px;margin-right:5px;">
  ...
  <div style="clear:both;display:inline;float:left;margin-bottom:5px;">
    <input type="button" class="btn btn-success"value="상품삭제" onClick="deleteProduct()"/>
  </div>
