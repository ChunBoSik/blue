...
<nav class="navbar navbar-expand-sm bg-light justify-content-center">
  <ul class="navbar-nav">
    ...
    <li class="nav-item dropdown">
      ...
      <ul>
        <li><a class="drop-text" href="${contextPath }/shopping/admin/orderList">주문목록</a></li>
      </ul>
    </li>
    <li class="nav-item">
    ...
    <li class="nav-item">
      <a class="nav-link" href="${contextPath }/admin/main">메인화면관리</a>
    </li>
    <li class="nav-item">
      <a class="nav-link" href="${contextPath }/admin/member">회원관리</a>
    </li>
    <li class="nav-item">
    ...
    <li class="nav-item">
      <a class="nav-link" href="${contextPath }/admin/board">게시글관리</a>
    </li>
  </ul>
</nav>
</body>
