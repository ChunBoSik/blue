...
<head>
  ...
  <script>
    function paymentCheck() {
      ...
      alert("결제 완료되었습니다.\n\n'주문조회'에서 확인하세요!");
      location.href="${contextPath}/shopping/paymentOk";
    }
  </script>
</head>
<body>
...
<div class="container">
  ...
  <form method="post">
    ...
    <p>
      <button type="button" class="btn btn-secondary" onclick="location.href='${contextPath}/shopping/product';">계속쇼핑하기</button> &nbsp;
