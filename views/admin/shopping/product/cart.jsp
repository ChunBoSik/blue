  ...
  <div>
    ...
    <c:forEach var="vo" items="${vos}">
      ...
      <c:if test="${imsiVo ne vo}">
        <c:if test="${sw eq 1}">
          <p>
            [<a href="${contextPath}/shopping/productGroupDel?product=${imsiVo}">주문취소</a>]/
            [<a href="${contextPath}/shopping/productDel?product=${imsiVo}">수량1개감소</a>]
            [<a href="${contextPath}/shopping/productAdd?product=${imsiVo}">수량1개증가</a>]
    ...
    <hr/>
    <p>
      [<a href="${contextPath}/shopping/product">계속쇼핑하기</a>] /
      [<a href="${contextPath}/shopping/order">주문하기</a>] /
      [<a href="${contextPath}/shopping/orderReset">전체주문취소</a>]
    </p>
  </div>
</div>
