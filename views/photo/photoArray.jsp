...
<div class="container">
  ...
  <div class="container" align="center">
    <c:forEach var="vo" items="${vos}">
      <a href="${contextPath}/photo/photoContent?idx=${vo.idx}&page=${cri.page}&backPart=${part}"><img src="${contextPath}/photo/${vo.thumbnail}" width="150px" title="${vo.title}"/></a> &nbsp; &nbsp; &nbsp;
    </c:forEach>
  </div>
  <hr/>
  <p><br/></p>
